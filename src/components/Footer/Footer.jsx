                ...
                <div className="footer__top">
                    <Link to="/home" className="header__logo">
                        <div className="footer__logo-container">
                            ...
                            <p className="logo__text"><span className="logo__span"> ТОРГОВЫЙ ДОМ УЭТ</span></p>
                        </div>
                    </Link>
